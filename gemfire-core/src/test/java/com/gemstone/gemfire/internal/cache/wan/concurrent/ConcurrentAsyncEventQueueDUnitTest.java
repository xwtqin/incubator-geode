...
public class ConcurrentAsyncEventQueueDUnitTest extends AsyncEventQueueTestBase {
  ...
  public void testReplicatedSerialAsyncEventQueueWithMultipleDispatcherThreadsOrderPolicyThread() {
    ...
    AsyncInvocation inv1 = vm4.invokeAsync(AsyncEventQueueTestBase.class, "doPuts", new Object[] { getTestName() + "_RR",
        50 });
    AsyncInvocation inv2 = vm4.invokeAsync(AsyncEventQueueTestBase.class, "doNextPuts", new Object[] { getTestName() + "_RR",
      50, 100 });
    AsyncInvocation inv3 = vm4.invokeAsync(AsyncEventQueueTestBase.class, "doNextPuts", new Object[] { getTestName() + "_RR",
      100, 150 });
