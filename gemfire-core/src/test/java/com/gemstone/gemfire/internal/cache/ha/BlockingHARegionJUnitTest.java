 ...
 */
  ...
  public void testPutBeingBlocked()
  {
    try {
      ...
      Threads.join(thread1, 30 * 1000); // for completeness
      Threads.join(thread2, 30 * 1000);
      if (exceptionOccured) {
        fail(" Test failed due to " + exceptionString);
      }
  ...
  public void _testConcurrentPutsTakesNotExceedingLimit()
  {
    try {
      ...
      Threads.join(thread6, 30 * 1000);
      Threads.join(thread7, 30 * 1000);
      Threads.join(thread8, 30 * 1000);
      Threads.join(thread9, 30 * 1000);
      Threads.join(thread10, 30 * 1000);
